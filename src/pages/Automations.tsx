            ...
            <div className="text-center">
              ...
              >
                <Button variant="hero" size="lg" asChild className="text-base">
                  <TrackedLink to="/get-started" trackingLabel="automations_hero_book_call" className="gap-2">
                    Book a Demo Call
                    <ArrowRight size={18} />
                  </TrackedLink>
                </Button>
            ...
            <ScaleIn>
              ...
              >
                ...
                <div className="relative p-8 md:p-12 lg:p-16 text-center">
                  ...
                  >
                    <TrackedLink to="/get-started" trackingLabel="automations_cta_book_call" className="gap-2">
                      Book Your Demo Call
                      <ArrowRight size={18} />
                    </TrackedLink>
                  </Button>
