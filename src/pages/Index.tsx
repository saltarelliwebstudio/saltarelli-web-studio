      ...
      <section id="pricing" className="py-20 px-6 relative z-10 bg-card/30 backdrop-blur-sm">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-8">
            <PricingCard title="Website Creation" price="$499" description="Build your new website from scratch" features={["1-3 week turnaround", "1 round of revisions included", "Professional design and build", "Domain setup & basic SEO", "50% non-refundable deposit required"]} />
            <PricingCard title="Website Redesign" price="$499" description="Refresh and modernize your existing site" features={["1-3 week turnaround", "1 round of revisions included", "Modern, responsive design", "SEO optimization included", "50% non-refundable deposit required"]} popular={true} />
          </div>
